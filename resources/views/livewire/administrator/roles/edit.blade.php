                ...
                <div class="w-1/2 px-6 py-4 shadow-md rounded-3xl bg-white">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            type="text" name="role" placeholder="Nama Role" wire:model="name">
                        @error('role')
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2 grid grid-cols-2">
                                @foreach ($permissions as $permission)
                                    <div>
                                        <label class="mt-2 relative inline-flex items-start cursor-pointer">
                                        ...
                                        <div class="w-9 h-5 bg-gray-400 hover:bg-gray-500 peer peer-focus:outline-0 peer-focus:ring-transparent rounded-full  transition-all ease-in-out duration-500 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-800 hover:peer-checked:bg-indigo-900"></div>
