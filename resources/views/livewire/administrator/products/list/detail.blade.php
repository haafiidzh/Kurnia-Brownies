<div class="flex gap-5 mb-5">
    ...
    <div class="w-1/3 gap-5 flex flex-col">
            ...
            <div class="px-6 pb-2">
                <div class="flex flex-col gap-1 text-sm p-2 border border-slate-700 rounded">
                    ...
                    <p class="flex items-center gap-1">
                        <i class="{{ $data->recommended == true ? 'text-green-600 fa-solid fa-circle-check' : 'text-gray-500 fa-solid fa-circle-info' }}"></i>
                        <span>{{ $data->recommended == true ? 'Recommended' : 'Common' }}</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="py-3 shadow-md rounded-xl bg-white">
            ...
            <div class="border-b border-slate-700"></div>
            <div class="flex flex-col mt-3 px-6 {{ $data->detail ?: 'h-[220px] overflow-y-scroll' }}">
