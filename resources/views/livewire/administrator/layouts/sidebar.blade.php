                        ...
                        @canany($item['permission'], 'web')
                            ...
                            @else
                                <div x-data="{ child: {{ $item['active'] ? 'true' : 'false' }} }" >
                                    <li>
                                        <div  @click="child = !child" :class="child ? 'bg-gray-100 px-4 py-2 text-gray-700' : 'text-gray-500'"
                                            ...
                                            <i :class="child ? 'fa-rotate-90' : ''" class="fa-solid fa-chevron-right text-xs transition-all duration-300"></i>
                                        </div>
                                    </li>
                                    <li x-show="child"
                                    x-transition:enter="transition translate-y-0 ease-out duration-300"
