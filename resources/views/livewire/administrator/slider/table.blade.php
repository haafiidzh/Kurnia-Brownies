<div x-data="{ preview: false, scrollPosition: 100 }">
        ...
        <div class="w-full bg-slate-100 rounded-xl shadow-md overflow-hidden">
            ...
            <table class="w-full">
                <thead class="bg-gray-300 text-sm">
                    ...
                    <th class="px-4 py-2 text-center w-20">Likes</th>
                ...
                <tbody class="text-sm" wire:sortable="updateTaskOrder">
                    ...
                    @forelse ($datas as $index => $data)
                        ...
                        <tr wire:sortable.item="{{ $data->id }}" wire:key="slider-{{ $data->id }}"
                            ...
                            <td class="w-28 px-4 py-2 text-center">{{ dateTimeTranslated($data->created_at) }}
                            </td>
                                ...
                                <div class="flex gap-2 justify-center">
                                    ...
                                    @can('edit-slider')
                                        <a href="{{ route('administrator.sliders.edit', ['id' => $data->id]) }}"
                                            ...
                                            title="Edit Slider"><i class="fa-solid fa-eye-dropper text-xs"></i></a>
                                    @endcan
    ...
    {{-- Preview Image --}}
    <div x-show="preview" x-cloak x-transition:enter="transition translate-y-0 ease-out duration-200"
