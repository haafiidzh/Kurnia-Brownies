<section class="px-10 lg:px-[120px] py-20">
    <div class="flex justify-center mb-0 md:mb-20">
        <div class=" inline-block text-center">
            <h2 class="text-center font-nunito italic text-3xl md:text-5xl text-primary font-bold drop-shadow-md pb-2 md:pb-4">{{ cache('homepage.news-title') ?: 'Latest News' }}</h2>
        ...
        @foreach ($datas as $data)
            <div class="flex flex-col gap-3" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true" data-aos-easing="ease-out">
                <a class="relative overflow-hidden group " href="{{ route('news.detail', $data->slug) }}">
                    ...
                    <img loading="lazy" class="aspect-video object-cover group-hover:scale-125 transition-all duration-300"
