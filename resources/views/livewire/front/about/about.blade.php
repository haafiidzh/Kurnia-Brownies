    ...
    <div class="w-[92%] relative flex flex-col items-end overflow-hidden">
        ...
        <div class="px-10 md:pl-20 md:pr-0 py-10 md:py-0 flex flex-col-reverse items-center md:flex-row gap-0 md:gap-10 w-full relative">
            ...
            <div class="h-full md:w-1/2 -z-10 rounded-xl md:rounded-none overflow-hidden"> 
                <img class="object-cover h-full w-full" src="{{ url(cache('about.page-background-section.1') ?: 'assets/images/default/about/1.jpg') }}" alt="" data-aos="fade" data-aos-duration="500" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-once="true">
            </div>
        </div>
        ...
        <div class="px-10 md:pr-20 md:pl-0 py-10 md:py-0 flex flex-col-reverse items-center md:flex-row-reverse gap-0 md:gap-10 w-full relative">
            ...
            <div class="h-full md:w-1/2 -z-10 rounded-xl md:rounded-none overflow-hidden"> 
                <img class="object-cover h-full w-full" src="{{ url(cache('about.page-background-section.2') ?: 'assets/images/default/about/2.jpg') }}" alt="" data-aos="fade" data-aos-duration="500" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-once="true">
            </div>
        </div>
        ...
        <div class="px-10 md:pl-20 md:pr-0 py-10 md:py-0 flex flex-col-reverse items-center md:flex-row gap-0 md:gap-10 w-full relative">
            ...
            <div class="h-full md:w-1/2 -z-10 rounded-xl md:rounded-none overflow-hidden"> 
                <img class="object-cover h-full w-full" src="{{ url(cache('about.page-background-section.3') ?: 'assets/images/default/about/5.jpg') }}" alt="" data-aos="fade" data-aos-duration="500" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-once="true">
            </div>
        </div>
        ...
        <div class="px-10 md:pr-20 md:pl-0 py-10 md:py-0 flex flex-col-reverse items-center md:flex-row-reverse gap-0 md:gap-10 w-full relative">
            ...
            <div class="h-full md:w-1/2 -z-10 rounded-xl md:rounded-none overflow-hidden"> 
                <img class="object-cover h-full w-full" src="{{ url(cache('about.page-background-section.4') ?: 'assets/images/default/about/4.jpeg') }}" alt="" data-aos="fade" data-aos-duration="500" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-once="true">
            </div>
        </div>
        ...
        <div class="px-10 md:pl-20 md:pr-0 py-10 md:py-0 flex flex-col-reverse items-center md:flex-row gap-0 md:gap-10 w-full relative">
            ...
            <div class="h-full md:w-1/2 -z-10 rounded-xl md:rounded-none overflow-hidden"> 
                <img class="object-cover h-full w-full" src="{{ url(cache('about.page-background-section.5') ?: 'assets/images/default/about/3.jpg') }}" alt="" data-aos="fade" data-aos-duration="500" data-aos-easing="ease-in" data-aos-delay="1000" data-aos-once="true">
            </div>
        </div>
    </div>
</div>