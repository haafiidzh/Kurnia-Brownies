...
<div x-data="{ detail: false, detailChild: false, selectedImage:'' }" class="relative">
    ...
    <div class="px-10 lg:px-[120px] py-16 relative">
        <div class="flex gap-10 mb-10 flex-col md:flex-row">
            <div class="w-full md:w-1/3 flex flex-col items-center gap-5">
                <div class="h-[400px] overflow-hidden relative drop-shadow-xl">
                    <img class="object-cover rounded-lg object-center h-full w-auto " src="{{ url($data->image) }}"
                        alt="">
            ...
            <div class="w-full md:w-2/3 flex items-center">
                <div class="flex flex-col gap-10">
                    ...
                    <!-- Deskripsi -->
                    <div class="text-lg text-gray-800 leading-relaxed font-poppins">
                        {!! $data->description !!}
                    </div>
                </div>
            </div>
        ...
        <div>
            <h1 class="font-nunito text-5xl mb-10 text-center font-semibold text-primary drop-shadow-md">Produk Lainnya</h1>

            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($relatedProducts as $item)
                <a href="{{ route('product.detail', $item->slug) }}">
                    <div class="relative rounded-3xl w-full h-[400px] group overflow-hidden drop-shadow-md">
                        <img src="{{ $item->image }}" alt="Produk" class="w-full h-full object-cover absolute -z-10 group-hover:scale-125 transition-all duration-300"/>
