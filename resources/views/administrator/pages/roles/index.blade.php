...
@section('content')
    ...
    <div class="mb-7 py-3 flex justify-between">
        <h1 class="font-bold text-3xl">Role</h1>
        @can('create-roles')
            <a href="{{ route('administrator.roles.create') }}"
                ...
                <i class="text-xs fa-solid fa-plus"></i> &nbsp; Tambah Role
            </a>
        @endcan
    </div>

    <livewire:administrator.roles.table>
@endsection
